...
// paid unpaid testing 
if (isset($_SESSION['key'])) {
    if (@$_GET['unpaiduser'] && $_SESSION['key'] == '54585c506829293a2d4c3b68543b316e2e7a2d277858545a36362e5f39') {
        $eid = @$_GET['unpaiduser'];
        $r1 = mysqli_query($con, "UPDATE user SET premium='UNPAID' WHERE username='$eid' ") or die('Error');
        
        }
        header("location:dash.php?q=1");
    }
if (isset($_SESSION['key'])) {
    if (@$_GET['paiduser'] && $_SESSION['key'] == '54585c506829293a2d4c3b68543b316e2e7a2d277858545a36362e5f39') {
        $eid = @$_GET['paiduser'];
        $r1 = mysqli_query($con, "UPDATE user SET premium='PAID' WHERE username='$eid' ") or die('Error');
        
        }
        header("location:dash.php?q=1");
    }
// end of paid unpaid testing
...
if (isset($_SESSION['key'])) {
    if (@$_GET['q'] == 'addquiz' && $_SESSION['key'] == '54585c506829293a2d4c3b68543b316e2e7a2d277858545a36362e5f39') {
        ...
        $status  = "disabled";
        $id      = uniqid();
        $q3      = mysqli_query($con, "INSERT INTO quiz VALUES(NULL,'$id','$name','$category','$correct','$wrong','$total','$time', 'NOW()','$status')");
