...
<div class="col-lg-6">
<span class="navbar-brand">EduTech Future</span></div>
...
if (!(isset($_SESSION['username']))) {
    ...
    include_once 'dbConnection.php';
    echo '<span class="pull-right top title1" ><span style="color:white"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>&nbsp;&nbsp;&nbsp;&nbsp;WELCOME,</span> <span class="log log1" style="color:lightyellow">' . $username . '&nbsp;&nbsp;|&nbsp;&nbsp;<a href="logout.php?q=account.php" style="color:lightyellow;"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span>&nbsp;Logout</button></a></span>';
}
?>
<a href="https://imjo.in/Vh8bry" target="_blank" style="text-decoration: none; color: white; font-size: 20px; padding-right:25px;">PREMIUM</a>
</div>
</div></div>
<div class="bg">
...
if (@$_GET['q'] == 1)
    echo 'class="active"';
?> ><a href="account.php?q=1"><span class="glyphicon glyphicon-home" aria-hidden="true"></span>&nbsp; Mock Tests<span class="sr-only">(current)</span></a></li>
        <li <?php
if (@$_GET['q'] == 2)
    echo 'class="active"';
...
if (@$_GET['q'] == 7)
    echo 'class="active"';
?> ><a href="account.php?q=7">&nbsp; PHYSICS<span class="sr-only">(current)</span></a></li>
        <li <?php
if (@$_GET['q'] == 8)
    echo 'class="active"';
?>><a href="account.php?q=8"></span>&nbsp; CHEMISTRY</a></li>
    <li <?php
if (@$_GET['q'] == 9)
    echo 'class="active"';
?>><a href="account.php?q=9">&nbsp; BIOLOGY</a></li>
...
if (@$_GET['q'] == 7) {
    ...
    $result = mysqli_query($con, "SELECT * FROM quiz WHERE status = 'enabled' AND category= 'Physics' ORDER BY date DESC") or die('Error');
    echo '<div class="content panel" ><table class="container table table-striped title1"  style="vertical-align:middle">
...
if (@$_GET['q'] == 8) {
    ...
    $result = mysqli_query($con, "SELECT * FROM quiz WHERE status = 'enabled' AND category= 'Chemistry' ORDER BY date DESC") or die('Error');
...
if (@$_GET['q'] == 9) {
    ...
    $result = mysqli_query($con, "SELECT * FROM quiz WHERE status = 'enabled' AND category= 'Biology' ORDER BY date DESC") or die('Error');
    echo '<div class="panel"><table class="table table-striped title1"  style="vertical-align:middle">
<tr><td style="vertical-align:middle"><b>S.N.</b></td><td style="vertical-align:middle"><b>Name</b></td><td style="vertical-align:middle"><b>Total question</b></td><td style="vertical-align:middle"><b>Correct Answer</b></td><td style="vertical-align:middle"><b>Wrong Answer</b></td><td style="vertical-align:middle"><b>Total Marks</b></td><td style="vertical-align:middle"><b>Time limit</b></td><td style="vertical-align:middle"><b>Action</b></td></tr>';
    $c = 1;
    while ($row = mysqli_fetch_array($result)) {
...
<br />';
            ...
            echo '</div>';
            echo '<div class="panel" style="text-align:center; background-color:black;">';
...
if (@$_GET['q'] == 3) {
    ...
    echo '<div class="panel title">
<table class="table table-striped title1" >
<tr><td style="vertical-align:middle"><b>Rank</b></td><td style="vertical-align:middle"><b>Name</b></td><td
    style="vertical-align:middle"><b>Username</b></td><td style="vertical-align:middle"><b>Score</b></td></tr>';
    $c = $showfrom-1;
...
<a href="feedback.php" style="color:black;text-decoration:underline;" onmouseover="this.style('color:yellow')" target="new">Feedback</a></div>
