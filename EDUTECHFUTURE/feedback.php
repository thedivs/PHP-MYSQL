...
<nav class="navbar navbar-dark bg-primary" style="color: white;">
  <div class="container-md">
      ...
      <span class="navbar-brand" style="float: right;">Contact us :<span style="color: black;">&nbsp;+91-9557963838</span></span>
...
<div class="form-group">
  ...
  <div class="col-md-6">
  <input id="username" name="username" placeholder="Enter your username" class="form-control input-md" type="username">
...
<span style="font-family: sans-serif; font-size: 15px;">Welcome to the EDUTECH FUTURE. We help you in different types of EXAMS through QUIZES. You can prepare yourself by taking Daily Quizes. You can mail us on<b> vikas764122@gmail.com</b> for any suggestions/query. You can call us on <b>+91-9557963838.</b><br> <br>Send the Feedback form to get us know about our quizes.</span>
...
<font style="font-size:12px;font-weight:bold"><input type="submit" name="submit" value="Send My Feedback" class="btn btn-success" /></font>
</div>
</form>';
}
?>
...
<span href="#" data-target="#login" style="color:lightyellow">EduTech Future<br><br></span></div>
